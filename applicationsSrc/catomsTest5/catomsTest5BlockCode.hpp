...
class CatomsTest5BlockCode : public Catoms3DBlockCode {
private:
    int distance;
...
public:
    ...
    CatomsTest5BlockCode(Catoms3DBlock *host);
    ...
    static BlockCode *buildNewBlockCode(BuildingBlock *host) {
        return (new CatomsTest5BlockCode((Catoms3DBlock *) host));
    };
};
