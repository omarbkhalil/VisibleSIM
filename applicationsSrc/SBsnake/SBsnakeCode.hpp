...
#ifndef SBsnakeCode_H_
#define SBsnakeCode_H_
...
class SBsnakeCode : public SlidingCubesBlockCode {
private:
...
public :
	SBsnakeCode(SlidingCubesBlock *host);
	~SBsnakeCode() {};
...
/** needed to associate code to module                                      **/
	static BlockCode *buildNewBlockCode(BuildingBlock *host) {
	    return(new SBsnakeCode((SlidingCubesBlock*)host));
	}
/*****************************************************************************/
};
