...
class CatomsTest1BlockCode : public Catoms3DBlockCode {
private:
    int distance;
...
public:
    CatomsTest1BlockCode(Catoms3DBlock *host);
    ~CatomsTest1BlockCode() {};
    ...
    static BlockCode *buildNewBlockCode(BuildingBlock *host) {
        return (new CatomsTest1BlockCode((Catoms3DBlock*)host));
    };
};
