#ifndef CatomsTest6BlockCode_H_
#define CatomsTest6BlockCode_H_
...
class CatomsTest6BlockCode : public Catoms3DBlockCode {
private:
    int distance;
...
public:
    CatomsTest6BlockCode(Catoms3DBlock *host);
    ~CatomsTest6BlockCode() {};
    ...
    static BlockCode *buildNewBlockCode(BuildingBlock *host) {
        return (new CatomsTest6BlockCode((Catoms3DBlock*)host));
    };
};
