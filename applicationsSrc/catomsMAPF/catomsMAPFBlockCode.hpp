#ifndef CatomsMAPFBlockCode_H_
#define CatomsMAPFBlockCode_H_
...
class CatomsMAPFBlockCode : public Catoms3DBlockCode {
private:
...
int reverseIndex = -1;
    ...
    CatomsMAPFBlockCode(Catoms3DBlock *host);
    ~CatomsMAPFBlockCode() {};
...
//    std::array<Cell3DPosition, 12> getTargetFBPlus16X() const;
   ...
   shiftPlusX(const std::array<Cell3DPosition, N>& src, int dx) {
    ...
    static BlockCode *buildNewBlockCode(BuildingBlock *host) {
        return (new CatomsMAPFBlockCode((Catoms3DBlock*)host));
    };
};

#endif /* CatomsMAPFBlockCode_H_ */
