#include "test1BlockCode.hpp"

using namespace BlinkyBlocks;

Test1BlockCode::Test1BlockCode(BlinkyBlocksBlock *host) : BlinkyBlocksBlockCode(host) {
    ...
    addMessageEventFunc2(SAMPLE_MSG_ID,
                         std::bind(&Test1BlockCode::handleSampleMessage, this,
...
void Test1BlockCode::handleSampleMessage(std::shared_ptr<Message> _msg,
...
void Test1BlockCode::onMotionEnd() {
...
void Test1BlockCode::processLocalEvent(EventPtr pev) {
...
void Test1BlockCode::onBlockSelected() {
    // Debug stuff:
    cerr << endl << "--- PRINT MODULE " << *module << "---" << endl;

}

void Test1BlockCode::onAssertTriggered() {
...
bool Test1BlockCode::parseUserCommandLineArgument(int &argc, char **argv[]) {
...
string Test1BlockCode::onInterfaceDraw() {
    stringstream trace;
