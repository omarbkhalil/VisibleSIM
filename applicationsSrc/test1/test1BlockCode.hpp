#ifndef Test1BlockCode_H_
#define Test1BlockCode_H_
...
class Test1BlockCode : public BlinkyBlocksBlockCode {
private:
    int distance;
    BlinkyBlocksBlock *module;
public :
    Test1BlockCode(BlinkyBlocksBlock *host);
    ~Test1BlockCode() {};
...
/** needed to associate code to module                                      **/
    static BlockCode *buildNewBlockCode(BuildingBlock *host) {
        return (new Test1BlockCode((BlinkyBlocksBlock*)host));
    };
/*****************************************************************************/
};

#endif /* Test1BlockCode_H_ */
